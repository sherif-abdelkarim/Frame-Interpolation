...
def main(model_params):
    ...
    # in case you have generated residual data using write_image.py, you can use DataGenerator instead of ResidualDataGenerator.
    # you can uncomment the line below and comment out the line after that. Make sure you are passing the path to the residual data directory to the image_dir argument.
    #train_generator = DataGenerator(list_IDs=list_ids, batch_size=batchsize, image_dir=train_file_path, shuffle=True)
    train_generator = ResidualDataGenerator(list_IDs=list_ids, batch_size=batchsize, image_dir=train_file_path, shuffle=True)
